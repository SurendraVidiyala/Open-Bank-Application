...
/**
 * Response Body for Backbase application with member variables, getters,
 * setters methods
 * 
...
@JsonPropertyOrder({ "id", "accountId", "counterpartyAccount", "counterpartyName", "counterPartyLogoPath",
		"instructedAmount", "instructedCurrency", "transactionAmount", "transactionCurrency", "transactionType",
		"description" })
public class BackbaseResponseBody {
	@JsonProperty("id")
	private String id;
